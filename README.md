...
To overcome the "analytics bottleneck" where loading massive datasets exceeds edge RAM, the document proposes using **Principal Component Analysis (PCA)** [[Illustration 10]](images/eia10.png).
